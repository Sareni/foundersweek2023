...
try:
	while(1):
		# Messung wird gestartet und das Ergebnis in die entsprechenden Variablen ge-schrieben
		...
		if Luftfeuchte is not None and Temperatur is not None:
			...
			# In dem Falle wird eine Fehlermeldung ausgegeben - ein Ergebnis sollte beimnächsten Versuch vorliegen
		else:
